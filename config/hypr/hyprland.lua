...
hl.config({
    general = {
        ...
        col = {
            active_border = { colors = {"rgba(cba6f7ee)", "rgba(b4beffee)"}, angle = 45 },
...
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("env QT_QPA_PLATFORMTHEME=hyprqt6engine dolphin"))
...
hl.bind(mainMod .. " + SHIFT + S", hl.dsp.exec_cmd("grim -g \"$(slurp)\" '/home/philly/Bilder/Bildschirmfotos/Screenshot_'$(date +'%Y-%m-%d_%H-%M-%S').png"))
